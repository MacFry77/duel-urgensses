...
function renderLiveGames(){
  ...
  list.querySelectorAll('[data-watch-room]').forEach(button=>button.onclick=()=>{$('roomCodeInput').value=button.dataset.watchRoom;joinSpectatorRoom()});
}
